...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center pt-8 px-4 font-sans text-white">
            ...
            <div className="w-full max-w-md bg-spotify-dark p-12 rounded-2xl shadow-2xl border border-white/5">
                ...
                <p className="text-spotify-gray text-center text-sm font-bold mb-8">
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <User className="h-5 w-5 text-spotify-gray group-focus-within:text-white transition-colors" />
                            </div>
                            <input
                                name="fullName"
                                type="text"
                                required
                                className="w-full bg-spotify-light/50 border border-white/10 rounded-full pl-12 pr-4 py-3 text-sm text-white placeholder-spotify-gray focus:outline-none focus:ring-2 focus:ring-spotify-green transition-all"
                ...
                <div className="mt-8 pt-6 border-t border-white/10 text-center">
                    <p className="text-spotify-gray font-bold text-sm">
                        ...
                        <Link to="/login" className="text-white hover:text-spotify-green transition-colors underline underline-offset-4">
                            Log in here
                        </Link>
                    </p>
                </div>
